...
static void i2c1_init(void)
{
    i2c_handle i2c1_test             = {0};
    i2c1_test.p_i2cx                 = I2C1;
    i2c1_test.i2c_conf.clock_freq_hz = I2C_CLK_FREQ_100KHZ;
    i2c1_test.i2c_conf.fm_duty_cycle = I2C_FM_DUTY_2;
    i2c1_test.i2c_conf.own_address   = 0x42;
    i2c1_test.i2c_conf.speed_mode    = I2C_SPEED_MODE_STANDARD;
    i2c_init(&i2c1_test);
}
...
static void i2c1_master_transmit(void)
{
    ...
    while (1) {
        ...
        i2c_master_transmit(I2C1, TARGET_ADDR, string_test, sizeof(string_test) - 1, I2C_REPEATED_START_DISABLE);
    }
}
